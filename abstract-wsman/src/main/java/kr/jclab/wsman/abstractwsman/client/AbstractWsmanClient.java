...
public abstract class AbstractWsmanClient {
    ...
    public AbstractWsmanClient(Bus bus, String address) {
        this.bus = bus;
    ...
    public abstract JaxWsClientFactoryBean createClientFactoryBean();
...
//        factory.getFeatures().add(feature);
        ...
        configureJaxWsProxyFactoryBean(factory);
